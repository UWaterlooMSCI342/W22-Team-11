...
class GroupFeedbackByPeriodsTest < ApplicationSystemTestCase
  ...
  def test_team_summary_by_period
    ...
    average_rating = ((5+5).to_f/2).round(2)
  ...
  def test_view_by_period
    prof = User.create(email: 'msmucker@gmail.com', password: 'banana', password_confirmation: 'banana', first_name: 'Mark', last_name: 'Smucker', is_admin: true)
    user1 = User.create(email: 'charles2@gmail.com', password: 'banana', password_confirmation: 'banana', first_name: 'Charles1', last_name: 'Smucker', is_admin: false)
    user1.save!
    ...
    feedback = save_feedback(1, 2, 3, 4, 5, "Week 9 data 1", user1, DateTime.civil_from_format(:local, 2021, 3, 1), team)
    feedback2 = save_feedback(1, 2, 3, 4,5, "Week 9 data 2", user2, DateTime.civil_from_format(:local, 2021, 3, 3), team)
