...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback with default priority" do
    ...
    assert_difference('Feedback.count') do
        ...
        post feedbacks_url, params: { feedback: { comments: "test comment", collaboration: 2, communication: 5, team_support: 4, responsibility: 5, work_quality: 4  } }
    end
  ...
  test "should create feedback with selected priority" do
    ...
    assert_difference('Feedback.count') do
        ...
        post feedbacks_url, params: { feedback: { comments: "test comment", collaboration: 2, communication: 2, team_support: 4, responsibility: 5, work_quality: 4, priority: 0 } }
    end
    assert_redirected_to root_url
  end
  ...
  test "should update feedback" do
    # login professor
    post('/login', params: { email: 'msmucker@gmail.com', password: 'professor'})
    patch feedback_url(@feedback), params: { feedback: { comments: "test comment2", collaboration: 3, communication: 4, team_support: 4, responsibility: 5, work_quality: 4, priority: 1} }
