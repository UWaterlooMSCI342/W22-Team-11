...
class ReportTest < ActiveSupport::TestCase
    setup do
        ...
        @reportee = User.new(email: 'jameshalpert@dundermifflin.com', password: 'password', password_confirmation: 'password', first_name: 'Jim', last_name: 'Halpert', is_admin: false)
        @reporter.save
        @reportee.save
    end
